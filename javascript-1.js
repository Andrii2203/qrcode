...
$(document).ready(function() {
	...
	if(has_touch || screen.width <= 699) {
		...
		window.ondevicemotion = function(event) {
		    ...
		    accX = Math.round(event.accelerationIncludingGravity.x * 50) / 10;  
		    accY = Math.round(event.accelerationIncludingGravity.y * 50) / 10;  
		...
		$('.container').addClass('fullscreen').mousemove(function(e) {
			...
			accX = (((e.pageX - this.offsetLeft)*2 / width) * 50) - 10;
			accY = (((e.pageY - this.offsetTop)*2 / width) * 50) - 10;
