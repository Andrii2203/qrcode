...
$(document).ready(function() {
	...
	if(has_touch || screen.width <= 699) {
		...
		window.ondevicemotion = function(event) {
		    ...
		    accX = Math.round(event.accelerationIncludingGravity.x*1000) / 10;  
		    accY = Math.round(event.accelerationIncludingGravity.y*1000) / 10;  
		...
		$('.container').addClass('fullscreen').mousemove(function(e) {
			...
			accX = (((e.pageX - this.offsetLeft)*2 / width) * 1000) - 10;
			accY = (((e.pageY - this.offsetTop)*2 / width) * 1000) - 10;
